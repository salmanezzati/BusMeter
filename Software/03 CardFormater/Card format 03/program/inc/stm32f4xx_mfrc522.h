 ...
 */
#ifndef stm32f4xx_mfrc522_H
#define stm32f4xx_mfrc522_H 100
/**
 ...
 */
/* Default SPI used */
#ifndef MFRC522_1_SPI
#define MFRC522_1_SPI						SPI1
#define MFRC522_1_SPI_PINSPACK				TM_SPI_PinsPack_2
#endif

/* Default CS pin used */
#ifndef MFRC522_1_CS_PIN
#define MFRC522_1_CS_RCC					RCC_AHB1Periph_GPIOG
#define MFRC522_1_CS_PORT					GPIOG
#define MFRC522_1_CS_PIN					GPIO_Pin_8
#endif
...
#define MFRC522_1_CS_LOW					MFRC522_1_CS_PORT->BSRRH = MFRC522_1_CS_PIN;
#define MFRC522_1_CS_HIGH					MFRC522_1_CS_PORT->BSRRL = MFRC522_1_CS_PIN;
...
extern void MFRC522_1_Init(void);
...
extern MFRC522_Status_t MFRC522_Check_2(uint8_t* id);
/**
 * Compare 2 RFID ID's
